...
const gestionItems = [
  { title: 'Proveedores', icon: 'mdi-truck-outline', value: 'proveedores', to: '/path' },
  { title: 'Empleados', icon: 'mdi-account-group ', value: 'empleados', to: '/path' },
  { title: 'Productos', icon: 'mdi-package-variant-closed', value: 'productos', to: '/path' },
