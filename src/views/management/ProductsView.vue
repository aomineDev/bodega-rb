      ...
      <v-form ref="formRef" class="pa-3">
        <v-container fluid>
          <v-row>
            ...
            <!-- descripcion -->
            <v-col cols="12" md="12">
              <v-textarea label="Descripcion" variant="underlined" rows="2" auto-grow v-model="descripcion"
            ...
            <!-- precio unitario -->
            <v-col cols="12" md="6">
              <v-text-field label="Precio unitario" type="number" variant="underlined" v-model="precioUnitario" step="1"
                :rules="[rules.precio]"></v-text-field>
            </v-col>
            <!-- precio promociom -->
            <v-col cols="12" md="6">
              <v-text-field label="Precio promocion" type="number" variant="underlined" v-model="precioPromocion"
            ...
            <!-- inicion promocio -->
            <v-col cols="12" md="6">
              <v-date-input v-model="inicioPromocion" label="Inicio de promocion" variant="underlined"></v-date-input>
            </v-col>
            <!-- fin promocion -->
            <v-col cols="12" md="6">
              <v-date-input v-model="finPromocion" label="Fin de promocion" variant="underlined"></v-date-input>
            </v-col>

            <!-- unidad de medida -->
            <v-col cols="12" md="6">
              <v-select label="Unidad de medidad" variant="underlined" :items="unidadesMedida" item-title="nombre"
                item-value="id" v-model="unidadMedida" :rules=[rules.unidadMedida]></v-select> </v-col>
          </v-row>
        </v-container>
      </v-form>
        ...
        <v-row class="flex-column flex-md-row">
          ...
          <v-col cols="12" md="5" class="d-flex">
            ...
            <v-card class="pa-1 d-flex align-center flex-grow-1" elevation="0">
              <v-img :src="product.imagen" contain max-width="100%" height="400" class="product-detail-img"></v-img>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" md="3">
            <!-- contenido intacto -->
            <v-card class=" d-flex flex-column justify-center columna-centra" elevation="0" style="height: 100%">
            ...
            <v-card class="mb-4 pa-5 columna-general" elevation="3" rounded="xl">
              ...
              <v-row>
                ...
                <v-col cols="12" sm="6">
                  ...
                  <div>
                    <v-progress-linear :model-value="(product.stockActual / 100) * 100" color="teal" height="30" rounded
